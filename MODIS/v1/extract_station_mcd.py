"""
Extract MCD19A2 MODIS AOD values for target stations — nearest-pixel only.
...
OUTPUT_DIR  = "/home/slow_data/Air_Quality/MODIS_MCD19A2/stations_aod_v4"
...
def extract_modis_for_stations(
    ...
    with rasterio.open(sample_path) as src:
        ...
        station_lats: list[float] = df_stations['latitude'].astype(float).tolist()
        station_lons: list[float] = df_stations['longitude'].astype(float).tolist()
        ...
        for i, station in enumerate(df_stations.itertuples()):
            ...
            # Skip stations outside this HDF tile
